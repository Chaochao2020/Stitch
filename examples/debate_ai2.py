...
moonshot_llm_config = {
    ...
    "api_key": 'sk-feQPhAb1bw9HRcVUoh65rxX6koHutleHVwKfTmSIpq5HEmXS',
    "model": 'moonshot-v1-8k'
}
deepseek_llm_config = {
    "api_type": 'openai',
    "api_key": 'sk-89ec48d428354ee5b3e812514d29096e',
...
class SpeakAloud(Action):
    ...
    PROMPT_TEMPLATE: str = """
    ## Background
    Suppose you are {name}, you and {opponent_name} will act as encyclopedias with rich knowledge, now I will give the question and the answer, now you need to have a conversation with {opponent_name} based on your rich knowledge and history To improve the answer, you need to give a reasonable answer after a friendly exchange.
    ## Related Information:
    {question}
    {answer}
    ...
    2. Give a reasonable answer after final negotiation. If you think the user's answer is already perfect, there is no need to improve it. The questions are multiple choice, meaning you can only choose one answer.
    3. Because I want to extract your output content, for the sake of uniformity, please ensure that the output format is {{"communication content": "xx", "complete answer": "xx"}}. In addition, the value of the "complete answer" can only be one of the options A, B, C, D.
    """
    name: str = "SpeakAloud"
...
async def debate(idea: str = "Now it's your turn to complete your answer." , investment: float = 3.0, n_round: int = 6):
...
def main(idea: str = "Now it's your turn to complete your answer.", investment: float = 3.0, n_round: int = 6):
    """
