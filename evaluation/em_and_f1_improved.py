...
def evaluate(predictions):
    ...
    for item in tqdm(predictions, desc="Evaluating"):
        if 'improved_output' in item and item['improved_output'] is not None:
            ground_truth = item['improved_output']
        else:
...
try:
    ...
    print(f"Successfully loaded {len(predictions)} items.")
    ...
    print("Please check if the file is a valid JSON file.")
